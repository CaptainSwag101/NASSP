...
bool Saturn::clbkLoadPanel (int id) {
	...
	if (id == SATPANEL_LEFT) { // left instrument panel
		...
		oapiRegisterPanelArea (AID_LEFTINTERIORLIGHTROTARIES,					_R(1032,  989, 1360, 1079), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN | PANEL_MOUSE_LBPRESSED | PANEL_MOUSE_UP, PANEL_MAP_BACKGROUND);
	...
	if (id == SATPANEL_RIGHT) { // right instrument panel
		...
		oapiRegisterPanelArea (AID_RIGHTINTERIORLIGHTROTARIES,					_R( 319,  974,  542, 1064), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN | PANEL_MOUSE_LBPRESSED | PANEL_MOUSE_UP,	PANEL_MAP_BACKGROUND);
		...
		if (Panel277)
		{
			oapiRegisterPanelArea(AID_CSM_PANEL_277, _R(1356, 662, 1511, 857), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN | PANEL_MOUSE_UP, PANEL_MAP_BACKGROUND);
		}
	...
	if (id == SATPANEL_LOWER_LEFT) { 
		...
		if (GNSplit) 
			...
			oapiSetPanelNeighbours(SATPANEL_CABIN_PRESS_PANEL, SATPANEL_TUNNEL, SATPANEL_LEFT, SATPANEL_GN);
	...
	if (id == SATPANEL_LOWER_MAIN) {
		...
		oapiSetPanelNeighbours(SATPANEL_LOWER_LEFT, SATPANEL_RIGHT_CB, top, SATPANEL_TUNNEL);
	...
	if (id == SATPANEL_TUNNEL) {
		...
		oapiSetPanelNeighbours(SATPANEL_LOWER_LEFT, SATPANEL_RIGHT_CB, SATPANEL_LOWER_MAIN, bottom);

		if (!ForwardHatch.IsOpen())
		{
			oapiRegisterPanelArea(AID_PRESS_EQUAL_VALVE_HANDLE,      _R(900, 480, 1021, 601), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,                    PANEL_MAP_BACKGROUND);
		}

		oapiRegisterPanelArea(AID_FORWARD_HATCH,                     _R(735, 367,  874, 702), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,                    PANEL_MAP_BACKGROUND);
	...
	if (id == SATPANEL_RIGHT_CB) { 
		...
		if (GNSplit) 
			...
			oapiSetPanelNeighbours(SATPANEL_TUNNEL, -1, SATPANEL_RIGHT, SATPANEL_GN);
...
void Saturn::AddRightMiddleMainPanelAreas(int offset) {
	...
	oapiRegisterPanelArea (AID_HIGHGAINANTENNAPITCHPOSITIONSWITCH,			_R(2268 + offset, 1016, 2358 + offset, 1116), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN | PANEL_MOUSE_LBPRESSED | PANEL_MOUSE_UP, PANEL_MAP_BACKGROUND);
	...
	oapiRegisterPanelArea (AID_HIGHGAINANTENNAYAWPOSITIONSWITCH,      		_R(2398 + offset, 1016, 2488 + offset, 1116), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN | PANEL_MOUSE_LBPRESSED | PANEL_MOUSE_UP, PANEL_MAP_BACKGROUND);
...
void Saturn::AddLeftLowerPanelAreas()
{
	...
	oapiRegisterPanelArea (AID_PANEL100LIGHTINGROTARIES,					_R( 602,  813,  946,  903), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN | PANEL_MOUSE_LBPRESSED | PANEL_MOUSE_UP, PANEL_MAP_BACKGROUND);
...
void Saturn::SetSwitches(int panel) {
	...
	SuitComprDeltaPMeter.WireTo(&ECSPressGroups1Feeder);
	...
	CONTHTRSMnACircuitBraker.Init( 76,  0, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], ECSRadiatorsCircuitBrakersRow, MainBusA, 5.0);
	CONTHTRSMnBCircuitBraker.Init(172,  0, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], ECSRadiatorsCircuitBrakersRow, MainBusB, 5.0);
	...
	ECSTransducerPressGroup1MnACircuitBraker.Init(338,  0, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], ECSCircuitBrakersRow, MainBusA, 5.0);
	ECSTransducerPressGroup1MnBCircuitBraker.Init(376,  0, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], ECSCircuitBrakersRow, MainBusB, 5.0);
	...
	ECSSecCoolLoopRADHTRMnACircuitBraker.Init(186,  0, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], ECSLowerRowCircuitBrakersRow, MainBusA, 5.0);
	ECSSecCoolLoopXducersMnACircuitBraker.Init(224,  0, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], ECSLowerRowCircuitBrakersRow, MainBusA, 5.0);
	ECSSecCoolLoopXducersMnBCircuitBraker.Init(262,  0, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], ECSLowerRowCircuitBrakersRow, MainBusB, 5.0);
	...
	CryogenicQTYAmpl1CB.Init	 (205,  43, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel226CircuitBreakersRow, &ACBus1PhaseC, 2.0);
	CryogenicQTYAmpl2CB.Init	 (205,   4, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel226CircuitBreakersRow, &ACBus2PhaseC, 2.0);
	CryogenicFanMotorsAC1ACB.Init(297, 305, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel226CircuitBreakersRow, &ACBus1PhaseA, 2.0);
	CryogenicFanMotorsAC1BCB.Init(297, 266, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel226CircuitBreakersRow, &ACBus1PhaseB, 2.0);
	CryogenicFanMotorsAC1CCB.Init(297, 227, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel226CircuitBreakersRow, &ACBus1PhaseC, 2.0);
	CryogenicFanMotorsAC2ACB.Init(297, 188, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel226CircuitBreakersRow, &ACBus2PhaseA, 2.0);
	CryogenicFanMotorsAC2BCB.Init(297, 121, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel226CircuitBreakersRow, &ACBus2PhaseB, 2.0);
	CryogenicFanMotorsAC2CCB.Init(297,  82, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel226CircuitBreakersRow, &ACBus2PhaseC, 2.0);
	...
	LightingNumIntLEBCB.Init	 (393, 182, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel226CircuitBreakersRow, &ACBus2PhaseA, 2.0);
	LightingNumIntLMDCCB.Init	 (393, 129, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel226CircuitBreakersRow, &ACBus1PhaseA, 2.0);
	LightingNumIntRMDCCB.Init	 (393,  86, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel226CircuitBreakersRow, &ACBus1PhaseB, 2.0);
	...
	if (Panel277)
	{
		Panel277->Panel277SwitchesRow.Init(AID_CSM_PANEL_277, MainPanel);
		Panel277->SPSPressIndFuelSwitch.Init(43, 33, 29, 30, srf[SRF_SWITCH90], srf[SRF_BORDER_29x30], Panel277->Panel277SwitchesRow);
		Panel277->SPSPressIndOxidSwitch.Init(110, 33, 29, 30, srf[SRF_SWITCH90], srf[SRF_BORDER_29x30], Panel277->Panel277SwitchesRow);
		Panel277->CSMLMFinalSepABatABraker.Init(71, 147, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel277->Panel277SwitchesRow);
		Panel277->CSMLMFinalSepBBatBBraker.Init(71, 97, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel277->Panel277SwitchesRow);
	}
	...
	PressEqualValve.Init(0, 0, 121, 121, srf[SRF_CSM_PRESS_EQUAL_HANDLE], NULL, PressEqualValveRow);
...
void Saturn::PanelRefreshForwardHatch() {
	...
	if (InPanel && PanelId == SATPANEL_TUNNEL) {
		if (oapiCameraInternal()) {
			oapiSetPanel(SATPANEL_TUNNEL);
		} else {
...
void Saturn::InitSwitches() {
	...
	FuelCellIndicatorsSwitch.AddPosition(0, 329);
	FuelCellIndicatorsSwitch.AddPosition(1,   0);
	FuelCellIndicatorsSwitch.AddPosition(2,  29);
	...
	RCSIndicatorsSwitch.AddPosition(0, 278);
	RCSIndicatorsSwitch.AddPosition(1, 309);
	RCSIndicatorsSwitch.AddPosition(2, 342);
	RCSIndicatorsSwitch.AddPosition(3,  16);
	RCSIndicatorsSwitch.AddPosition(4,  49);
	RCSIndicatorsSwitch.AddPosition(5,  81);
	...
	ECSIndicatorsSwitch.AddPosition(0, 342);
	ECSIndicatorsSwitch.AddPosition(1,  16);
	...
	SPSGimbalPitchThumbwheel.Register(PSH, "SPSGimbalPitchThumbwheel", 0.0, -4.0, 4.0, 0.5, false);
	SPSGimbalPitchThumbwheel.SetRotationRange(RAD * 293);
	SPSGimbalYawThumbwheel.Register(PSH, "SPSGimbalYawThumbwheel", 0.0, -4.0, 4.0, 0.5, true);
	...
	EcsGlycolPumpsSwitch.AddPosition(0, 238);
	EcsGlycolPumpsSwitch.AddPosition(1, 268);
	EcsGlycolPumpsSwitch.AddPosition(2, 301);
	EcsGlycolPumpsSwitch.AddPosition(3, 331);
	EcsGlycolPumpsSwitch.AddPosition(4, 356);
	EcsGlycolPumpsSwitch.Register(PSH, "EcsGlycolPumpsSwitch", 2);

	RightIntegralRotarySwitch.Register(PSH, "RightIntegralRotarySwitch", 0.0, 0.0, 10.0);
	RightIntegralRotarySwitch.SetRotationRange(300.0*RAD);
	RightIntegralRotarySwitch.SetOffset(-160.0*RAD);

	RightFloodRotarySwitch.Register(PSH, "RightFloodRotarySwitch", 0.0, 0.0, 10.0);
	...
	EMSFunctionSwitch.AddPosition(0,  179);
	EMSFunctionSwitch.AddPosition(1,  211);
	EMSFunctionSwitch.AddPosition(2,  240);
	EMSFunctionSwitch.AddPosition(3,  270);
	EMSFunctionSwitch.AddPosition(4,  300);
	EMSFunctionSwitch.AddPosition(5,  332);
	EMSFunctionSwitch.AddPosition(6,    0);
	EMSFunctionSwitch.AddPosition(7,   36);
	EMSFunctionSwitch.AddPosition(8,   60);
	EMSFunctionSwitch.AddPosition(9,   89);
	EMSFunctionSwitch.AddPosition(10, 115);
	EMSFunctionSwitch.AddPosition(11, 138);
	...
	VHFAntennaRotarySwitch.AddPosition(0, 303);
	VHFAntennaRotarySwitch.AddPosition(1,   0);
	VHFAntennaRotarySwitch.AddPosition(2,  57);
	VHFAntennaRotarySwitch.Register(PSH, "VHFAntennaRotarySwitch", 1);

	DCIndicatorsRotary.AddPosition(0, 211);
	DCIndicatorsRotary.AddPosition(1, 241);
	DCIndicatorsRotary.AddPosition(2, 270);
	DCIndicatorsRotary.AddPosition(3, 301);
	DCIndicatorsRotary.AddPosition(4, 329);
	DCIndicatorsRotary.AddPosition(5,   0);
	DCIndicatorsRotary.AddPosition(6,  30);
	DCIndicatorsRotary.AddPosition(7,  57);
	DCIndicatorsRotary.AddPosition(8,  89);
	DCIndicatorsRotary.AddPosition(9, 117);
	DCIndicatorsRotary.AddPosition(10,147);
	...
	ACIndicatorRotary.AddPosition(0, 277);
	ACIndicatorRotary.AddPosition(1, 308);
	ACIndicatorRotary.AddPosition(2, 342);
	ACIndicatorRotary.AddPosition(3,  16);
	ACIndicatorRotary.AddPosition(4,  49);
	ACIndicatorRotary.AddPosition(5,  82);
	...
	BatteryChargeRotary.AddPosition(0, 301);
	BatteryChargeRotary.AddPosition(1, 329);
	BatteryChargeRotary.AddPosition(2, 359);
	BatteryChargeRotary.AddPosition(3,  29);
	...
	NumericRotarySwitch.Register(PSH, "NumericRotarySwitch", 4.0, 0.0, 10.0);
	...
	IntegralRotarySwitch.Register(PSH, "IntegralRotarySwitch", 4.0, 0.0, 10.0);
	IntegralRotarySwitch.SetRotationRange(300.0*RAD);
	IntegralRotarySwitch.SetOffset(-150.0*RAD);

	FDAIPowerRotarySwitch.AddPosition(0, 355);
	FDAIPowerRotarySwitch.AddPosition(1,  25);
	FDAIPowerRotarySwitch.AddPosition(2,  60);
	FDAIPowerRotarySwitch.AddPosition(3,  96);
	FDAIPowerRotarySwitch.Register(PSH, "FDAIPowerRotarySwitch", 0);

	SCSElectronicsPowerRotarySwitch.AddPosition(0, 28);
	SCSElectronicsPowerRotarySwitch.AddPosition(1, 58);
	...
	BMAGPowerRotary1Switch.AddPosition(0, 27);
	BMAGPowerRotary1Switch.AddPosition(1, 58);
	BMAGPowerRotary1Switch.AddPosition(2, 89);
	BMAGPowerRotary1Switch.Register(PSH, "BMAGPowerRotary1Switch", 1);

	BMAGPowerRotary2Switch.AddPosition(0, 28);
	BMAGPowerRotary2Switch.AddPosition(1, 58);
	...
	LeftSystemTestRotarySwitch.AddPosition(6,   59);
	LeftSystemTestRotarySwitch.AddPosition(7,   89);
	LeftSystemTestRotarySwitch.AddPosition(8,  118);
	LeftSystemTestRotarySwitch.Register(PSH, "LeftSystemTestRotarySwitch", 4);
	
	RightSystemTestRotarySwitch.AddPosition(0,  310);
	RightSystemTestRotarySwitch.AddPosition(1,  342);
	RightSystemTestRotarySwitch.AddPosition(2,   17);
	RightSystemTestRotarySwitch.AddPosition(3,   49);
	RightSystemTestRotarySwitch.Register(PSH, "RightSystemTestRotarySwitch", 1);
	
	Panel100NumericRotarySwitch.Register(PSH, "Panel100NumericRotarySwitch", 4.0, 0.0, 10.0);
	Panel100NumericRotarySwitch.SetRotationRange(320.0*RAD);
	Panel100NumericRotarySwitch.SetOffset(-160.0*RAD);

	Panel100FloodRotarySwitch.Register(PSH, "Panel100FloodRotarySwitch", 0.0, 0.0, 10.0);
	Panel100FloodRotarySwitch.SetRotationRange(320.0*RAD);
	Panel100FloodRotarySwitch.SetOffset(-160.0*RAD);

	Panel100IntegralRotarySwitch.Register(PSH, "Panel100IntegralRotarySwitch", 4.0, 0.0, 10.0);
	Panel100IntegralRotarySwitch.SetRotationRange(320.0*RAD);
	Panel100IntegralRotarySwitch.SetOffset(-160.0*RAD);
