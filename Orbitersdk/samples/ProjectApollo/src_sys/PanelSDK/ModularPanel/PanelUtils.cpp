...
std::array<NTVERTEX, 4> RectangularPlaneVertices(RECT rect, float texScaleW, float texScaleH) {
...
void oapiBltToSketchpadDraw(oapi::Sketchpad* sketch, SURFHANDLE sourceSurface, int tgtX, int tgtY, int srcX, int srcY, int width, int height, bool colorKey) {
