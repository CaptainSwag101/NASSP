...
bool LEM::clbkLoadPanel (int id) {
	...
	case LMPANEL_MAIN: // LEM Main panel
		...
		oapiRegisterPanelArea (AID_MISSION_CLOCK,					_R( 668,  285,  830,  313), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,			  PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_EVENT_TIMER,						_R( 895,  285,  986,  312), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,			  PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_MPS_OXID_QUANTITY_INDICATOR,		_R(1065,  244, 1124,  268), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE, PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_MPS_FUEL_QUANTITY_INDICATOR,		_R(1065,  296, 1124,  321), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,			  PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_MPS_HELIUM_PRESS_INDICATOR,		_R(1194,  285, 1288,  312), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE, PANEL_MAP_BACKGROUND);
		...
		oapiRegisterPanelArea (AID_LM_DEDA_DISP,                     _R(2426, 1671, 2578, 1696), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,              PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_LM_DEDA_ADR,                      _R(2457, 1626, 2516, 1653), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,              PANEL_MAP_BACKGROUND);
