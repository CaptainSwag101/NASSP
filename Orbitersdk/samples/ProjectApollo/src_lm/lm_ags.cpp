...

{
	...
	if (Str[1] >= '0' && Str[1] <= '9') {
		Curdigit = Str[1] - '0';
		oapiBlt(surf, digits, dstx + DigitWidth * 0.9, dsty, DigitWidth * Curdigit, 0, DigitWidth, DigitHeight);
	}

	if (Str[2] >= '0' && Str[2] <= '9') {
		Curdigit = Str[2] - '0';
		oapiBlt(surf, digits, dstx + 2 * DigitWidth * 0.9, dsty, DigitWidth * Curdigit, 0, DigitWidth, DigitHeight);
	}
}
