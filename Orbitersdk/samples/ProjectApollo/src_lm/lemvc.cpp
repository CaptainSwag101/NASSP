...
void LEM::InitPanelVC() {
	...
	srf[SRF_VC_DIGITALDISP2] = oapiLoadTexture("ProjectApollo/VC/digits_el.dds");
...
void LEM::RegisterActiveAreas()
{
	...
	oapiVCRegisterArea(AID_VC_MISSION_CLOCK, _R(52*TexMul, 258*TexMul, 222*TexMul, 284*TexMul), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE, PANEL_MAP_BACKGROUND, MainPanelTex1);
	oapiVCRegisterArea(AID_VC_EVENT_TIMER, _R(276*TexMul, 258*TexMul, 360*TexMul, 284*TexMul), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE, PANEL_MAP_BACKGROUND, MainPanelTex1);
	...
	oapiVCRegisterArea(AID_VC_MPS_OXID_QUANTITY_INDICATOR, _R(442*TexMul, 217*TexMul, 488*TexMul, 240*TexMul), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE, PANEL_MAP_BACKGROUND, MainPanelTex1);
	oapiVCRegisterArea(AID_VC_MPS_FUEL_QUANTITY_INDICATOR, _R(442*TexMul, 269*TexMul, 488*TexMul, 294*TexMul), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE, PANEL_MAP_BACKGROUND, MainPanelTex1);
	oapiVCRegisterArea(AID_VC_MPS_HELIUM_PRESS_INDICATOR, _R(577*TexMul, 258*TexMul, 664*TexMul, 283*TexMul), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE, PANEL_MAP_BACKGROUND, MainPanelTex1);
	...
	oapiVCRegisterArea(AID_VC_LM_DEDA_DISP, _R(1800*TexMul, 97*TexMul, 1937*TexMul, 122*TexMul), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE, PANEL_MAP_BACKGROUND, MainPanelTex1);
	oapiVCRegisterArea(AID_VC_LM_DEDA_ADR, _R(1826*TexMul, 52*TexMul, 1890*TexMul, 77*TexMul), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE, PANEL_MAP_BACKGROUND, MainPanelTex1);
