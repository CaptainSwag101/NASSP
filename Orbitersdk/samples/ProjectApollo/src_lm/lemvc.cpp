...
//		sprintf(oapiDebugString(), "Numerics Voltage = %lf", lca.GetNumericVoltage());
	...
	case AID_VC_LM_CWS_LEFT:
		CWEA.RedrawLeft(sketch, panelObjectTextures[PO_TEX_CautionWarningLights], panelObjectLocations[PO_LOC_Main_CautionWarningLights_L], TexMul);
		return true;

	case AID_VC_LM_CWS_RIGHT:
		CWEA.RedrawRight(sketch, panelObjectTextures[PO_TEX_CautionWarningLights], panelObjectLocations[PO_LOC_Main_CautionWarningLights_R], TexMul);
		return true;
