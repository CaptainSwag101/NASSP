...
LEM::LEM(OBJHANDLE hObj, int fmodel) : Payload (hObj, fmodel), 
	...
	LandingGearPyros("Landing-Gear-Pyros", SystemSdk),
	LandingGearPyrosFeeder("Landing-Gear-Pyros-Feeder", SystemSdk),
	StagingBoltsPyros("Staging-Bolts-Pyros", SystemSdk),
	StagingNutsPyros("Staging-Nuts-Pyros", SystemSdk),
	CableCuttingPyros("Cable-Cutting-Pyros", SystemSdk),
	CableCuttingPyrosFeeder("Cable-Cutting-Pyros-Feeder", SystemSdk),
	DescentPropVentPyros("Descent-Prop-Vent-Pyros", SystemSdk),
	DescentPropVentPyrosFeeder("Descent-Prop-Vent-Pyros-Feeder", SystemSdk),
	DescentEngineStartPyros("Descent-Engine-Start-Pyros", SystemSdk),
	DescentEngineStartPyrosFeeder("Descent-Engine-Start-Pyros-Feeder", SystemSdk),
	DescentEngineOnPyros("Descent-Engine-On-Pyros", SystemSdk),
	DescentEngineOnPyrosFeeder("Descent-Engine-On-Pyros-Feeder", SystemSdk),
	DescentPropIsolPyros("Descent-Prop-Isol-Pyros", SystemSdk),
	DescentPropIsolPyrosFeeder("Descent-Prop-Isol-Pyros-Feeder", SystemSdk),
	AscentHeliumIsol1Pyros("Ascent-Helium-Isol1-Pyros", SystemSdk),
	AscentHeliumIsol1PyrosFeeder("Ascent-Helium-Isol1-Pyros-Feeder", SystemSdk),
	AscentHeliumIsol2Pyros("Ascent-Helium-Isol2-Pyros", SystemSdk),
	AscentHeliumIsol2PyrosFeeder("Ascent-Helium-Isol2-Pyros-Feeder", SystemSdk),
	AscentOxidCompValvePyros("Ascent-Oxid-Comp-Valve-Pyros", SystemSdk),
	AscentOxidCompValvePyrosFeeder("Ascent-Oxid-Comp-Valve-Pyros-Feeder", SystemSdk),
	AscentFuelCompValvePyros("Ascent-Fuel-Comp-Valve-Pyros", SystemSdk),
	AscentFuelCompValvePyrosFeeder("Ascent-Fuel-Comp-Valve-Pyros-Feeder", SystemSdk),
	RCSHeliumSupplyAPyros("RCS-Helium-Supply-A-Pyros", SystemSdk),
	RCSHeliumSupplyAPyrosFeeder("RCS-Helium-Supply-A-Pyros-Feeder", SystemSdk),
	RCSHeliumSupplyBPyros("RCS-Helium-Supply-B-Pyros", SystemSdk),
	RCSHeliumSupplyBPyrosFeeder("RCS-Helium-Supply-B-Pyros-Feeder", SystemSdk),
	agc(soundlib, dsky, imu, scdu, tcdu, SystemSdk),
	CSMToLEMPowerSource("CSMToLEMPower", SystemSdk),
	...
	CWEA(soundlib),
	DPS(th_hover),
	DPSPropellant(ph_Dsc, SystemSdk),
	APSPropellant(ph_Asc, SystemSdk),
	RCSA(ph_RCSA, SystemSdk, false),
	RCSB(ph_RCSB, SystemSdk, true),
	tca1A(2, 5, 8, 3, 5, 3, 7),
	...
	cdi(this),
	AOTLampFeeder("AOT-Lamp-Feeder", SystemSdk),
	NumDockCompLTGFeeder("Num-Dock-Comp-LTG-Feeder", SystemSdk),
	DescentECAMainFeeder("Descent-ECA-Main-Feeder", SystemSdk),
	DescentECAContFeeder("Descent-ECA-Cont-Feeder", SystemSdk),
	AscentECAMainFeeder("Ascent-ECA-Main-Feeder", SystemSdk),
	AscentECAContFeeder("Ascent-ECA-Cont-Feeder", SystemSdk),
